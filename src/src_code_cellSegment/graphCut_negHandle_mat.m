...
dat_in = cat(1, dat_in, [src_node + srcIds*0, srcIds, inf + srcIds*0]);     % connect source to sMap
...
dat_in = cat(1, dat_in, [sinkIds, sink_node + sinkIds*0, inf + sinkIds*0]); % connect sink to sMap
