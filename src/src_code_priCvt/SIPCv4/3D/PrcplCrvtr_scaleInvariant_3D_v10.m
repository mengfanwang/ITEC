function [curvature_merged,FGmap,curvature_all]=PrcplCrvtr_scaleInvariant_3D_v10(dat,smFactorLst,zRatio,BG)
...
if any(validLst)
    id=find(validLst,1);
    curvature_all_modified=(curvature_all)/sigmaLst(id);
else
    ...
    curvature_all_modified=(curvature_all)/sigmaLstHF;
end
