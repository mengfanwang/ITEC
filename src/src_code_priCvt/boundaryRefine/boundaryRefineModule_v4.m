function [newIdMap,thresholdMap]=boundaryRefineModule_v4(idMap,eig3d, vid,option)
%% 20230616, Wei Zheng
...
%     disp(i+"/"+N);
    ...
    [newLabel, comMaps_temp] = refineOneRegion_with_seed_parallel_v3(seed_id, comMaps{i},option);
