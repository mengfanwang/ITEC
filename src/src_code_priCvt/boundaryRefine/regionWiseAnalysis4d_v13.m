function [newIdMap_refined,thresholdMap] = regionWiseAnalysis4d_v13(seedMap,eig3d,vid,option)
%% 20230801, Wei Zheng
%% refine boundary
[newIdMap_refined,thresholdMap]=boundaryRefineModule_v3(seedMap,eig3d, vid,option);
